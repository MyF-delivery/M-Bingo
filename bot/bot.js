// ============================================================
// M-BINGO TELEGRAM BOT - FULL FEATURED (STABLE + ERROR HANDLING)
// ============================================================
...
if (!BOT_TOKEN) {
    console.error('❌ BOT_TOKEN is required! Please set it in your Render Environment variables.');
    process.exit(1);
}
...
// ============================================================
// TELEGRAM BOT (POLLING WITH AUTO-RETRY)
// ============================================================
const bot = new TelegramBot(BOT_TOKEN, { polling: false }); // Disable auto polling to control retries

// Global error handlers
process.on('uncaughtException', (error) => {
    console.error('❌ CRITICAL UNCAUGHT ERROR:', error.message, error.stack);
    // If it's a network issue, we retry after 5s instead of dying
...
bot.on('polling_error', (error) => {
    ...
    // Do not exit; let the polling retry automatically
});
...
// ... [You can keep the rest of your flows; just ensure you have `userState` defined at top] ...
// I will include it here for completeness (userState and adminLoginState)

// ============================================================
// USER STATE AND ADMIN LOGIN STATE (REQUIRED)
// ============================================================
const userState = {};
...
console.log('✅ M-BINGO Bot configuration loaded.');
startPolling(); // Start with retry
