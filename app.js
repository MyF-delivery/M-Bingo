...
// ============================================================
// ⭐ FIXED endGame — winner balance is now credited correctly
// ============================================================
async function endGame(roomId, winners) {
  ...
  //    If this fails, it will NOT roll back the winner's balance update.
  try {
    await pool.query(
...
app.post('/api/withdraw/request', async (req, res) => {
  ...
  // ⭐ NEW: block withdrawals when paused by AI agent auto-pause
