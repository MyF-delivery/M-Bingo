...
// ============================================================
// ⭐ COMMAND FUNCTIONS (extracted so they can be called directly)
// ============================================================
...
// ============================================================
// COMMAND REGISTRATION (bind the functions to onText)
// ============================================================
...
// ============================================================
// CALLBACK QUERY HANDLER — calls command functions directly
// ============================================================
bot.on('callback_query', async (call) => {
    ...
    // ---- Standard actions: call the handler functions directly ----
    const fakeMsg = {
        chat: { id: chatId },
