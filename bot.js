...
// ============================================================
// CALLBACK QUERY HANDLER (UPDATED with inline approve/reject)
// ============================================================
bot.on('callback_query', async (call) => {
    ...
    // ---- Stake selection (only 10 Birr allowed) ----
...
✅ Full House - All numbers on card
        ...
        // ---- Admin list actions (updated to show inline approve/reject) ----
        case 'admin_deposits': {
            ...
            try {
                ...
                // Send each deposit with approve/reject buttons
...
// ============================================================
// NOTIFICATION POLLER (uses 'notified' column)
// ============================================================
setInterval(async () => {
    try {
