...
// In-memory game state (This will be wiped if server restarts)
// Ideally, you should save this to your database
let activeGames = [];
            ...
            switch (data.type) {
                ...
                case 'startGame': {
                    ...
                    const gameData = {
                        ...
                        stake: 10,
                        totalCards: 5,
                        cards: await generatePlayerCards(ws.userId, 5),
                        calledNumbers: [],
                        calledCount: 0
                    };
...
function broadcastToAdmins(playersData) {
    // In this example, we broadcast to all connected sockets
    // In a real app, you'd have a specific list of admin IDs
...
async function generatePlayerCards(userId, count) {
    // Placeholder - just returns fake cards for demo
    const cards = [];
